...
# Parsing + Configuration Script – Nanotag - Rev. A

This **Parsing + Configuration** script is designed for the **Nanotag** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Nanotag Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Nanotag** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
